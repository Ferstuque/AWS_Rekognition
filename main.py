...
# Response for Recognize Celebrities
...
def draw_boxes(image_path: str, output_path: str, face_details: list[CelebrityTypeDef]):
    ...
    font = ImageFont.truetype("C:/Windows/Fonts/arial.ttf", 20) # For linux try path "Ubuntu-R.ttf"
...
if __name__ == "__main__":
    ...
    for photo_path in photo_paths:
        ...
        if not faces:
            print(f"No celebrities were found: {photo_path}")
            continue
